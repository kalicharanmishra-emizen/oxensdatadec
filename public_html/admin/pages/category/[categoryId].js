...
import { getApiType , getCategoryDetails,updateCategory} from 'reducers/categorySlice';
...
function Edit() {
    ...
    const categoryDetails = useSelector(state => state.categorySlice.categoryDetails)
